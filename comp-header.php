...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/mobile">
    <link rel="stylesheet" href="http://localhost/tablet">
    <link rel="stylesheet" href="http://localhost/desktop">
...
<body oncontextmenu="toggleMenu(); return false">
    <header>
        <div id="logo-burger-flex">
            <?= $burgerSVG ?>
            <a id="main-logo" href="/flights/<?= $language ?>"><div></div></a>
        </div>
        <div id="header-icons">
            <?php if($_SESSION){
                $link = '<a class="fat-with-orange-hover" href="/admin/'.$language.'">Admin</a>';
                echo $link;
            }
            ?>
            <a class="fat-with-orange-hover" href="/trips/<?= $language ?>">Trips</a>
